...
def helpMarkdown(handler, request):
	...
	print "Markdown is used to format task notes. The <a href=\"http://daringfireball.net/projects/markdown/\">official Markdown website</a> has pretty comprehensive documentation, but this page summarizes the syntax and lists some extensions"
